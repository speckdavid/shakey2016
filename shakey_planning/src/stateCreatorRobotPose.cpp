#include "shakey_state_creators/stateCreatorRobotPose.h"
#include <pluginlib/class_list_macros.h>
#include <visualization_msgs/MarkerArray.h>
#include <angles/angles.h>

PLUGINLIB_DECLARE_CLASS(shakey_state_creators, state_creator_robot_pose,
        shakey_state_creators::StateCreatorRobotPose, continual_planning_executive::StateCreator)

namespace shakey_state_creators
{
