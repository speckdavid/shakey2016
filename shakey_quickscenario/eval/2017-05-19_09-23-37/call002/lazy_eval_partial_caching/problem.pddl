(define (problem p01)
  ...
  (:objects
    ...
    wedge0_search_location_loc1_room0 - movable_object
    object_location_loc0_room0 object_location_loc1_room2 - object_location
    wedge0_search_location_loc1_room0_push_loc_0 wedge0_search_location_loc1_room0_push_loc_1 wedge0_search_location_loc1_room0_push_loc_2 - pushable_location
    room0 room1 room2 - room
    search_location_loc0_room2 search_location_loc1_room0 - search_location
  )
  (:init
    (at-base search_location_loc1_room0)
    ...
    (= (qw robot_location) 0.902264)
    (= (qx robot_location) 2.7975e-05)
    (= (qy robot_location) -3.69645e-05)
    (= (qz robot_location) -0.431183)
    (= (timestamp robot_location) 518.714)
    (= (x robot_location) -4.7935)
    (= (y robot_location) 3.19945)
