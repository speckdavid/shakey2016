(define (problem p01)
  ...
  (:init
    ...
    (= (qw robot_location) 0.782293)
    (= (qx robot_location) 5.14718e-07)
    (= (qy robot_location) -4.11971e-07)
    (= (qz robot_location) -0.622911)
    (= (timestamp robot_location) 612.135)
    (= (x robot_location) -5.31413)
    (= (y robot_location) 0.21162)
    (= (z robot_location) 0.0510449)
