(define (problem p01)
  ...
  (:init
    ...
    (= (qw robot_location) 0.69415)
    (= (qx robot_location) -2.82014e-07)
    (= (qy robot_location) -1.66354e-07)
    (= (qz robot_location) -0.71983)
    (= (timestamp robot_location) 732.12)
    (= (x robot_location) 4.931)
    (= (y robot_location) 1.25882)
    (= (z robot_location) 0.0510075)
