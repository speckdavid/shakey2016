(define (problem p01)
  ...
  (:init
    ...
    (= (qw robot_location) 0.70792)
    (= (qx robot_location) 1.31027e-07)
    (= (qy robot_location) -2.66636e-07)
    (= (qz robot_location) -0.706292)
    (= (timestamp robot_location) 894.602)
    (= (x robot_location) 8.77667)
    (= (y robot_location) -4.13386)
    (= (z robot_location) 0.0510104)
